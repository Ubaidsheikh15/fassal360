...
const Outer = ({ data: { title1, title2, decrypTexts, desciption, button } }) => {
...
const availableSlots = totalSlots - bookedSlots;
  ...
  return (
    <div className="ai-outer" style={{ position: "relative", overflow: "hidden" }}>
      <style jsx global>{`
        @keyframes pulse {
          0% { transform: scale(1); }
      ...
      <div className="container">
        <div className="ai-outer-container d-flex justify-content-between align-items-center">
          <div className="ai-outer-text">
            ...
            <div className="ai-outer-heading2"><DecryptText values={decrypTexts} /></div>
            <div className="ai-outer-description" style={{ color: "#666", margin: "1rem 0" }}>
              {desciption}
            </div>
            <div className="ai-outer-contact">
              <button onClick={handleOpenDialog} className="ai-button" style={{
              ...
              <p style={{ color: "#666", fontSize: "0.9rem", marginTop: "0.5rem", textAlign: "left", maxWidth: "350px" }}>
                Instantly unlock premium features, exclusive rewards, and priority access with a single click!
              </p>
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            <p style={{
              ...
              Hurry! Only {availableSlots} of {totalSlots} VIP Slots Remain – Claim Yours!
            </p>
            <p style={{
              color: "#333",
              fontSize: "1.1rem",
              ...
              Unlock a world of premium benefits, limited-time discounts, and elite community access. Enter your email to claim your VIP perks now!
            </p>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "1.5rem" }}>
              ...
              <button onClick={handleEmailSubmit} disabled={!email} style={{
                background: email
            ...
            <p style={{
              ...
              Click to send your email and unlock your exclusive benefits instantly!
            </p>
          </div>
        </div>
      )}
